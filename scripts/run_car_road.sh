...
python train_llff.py  -s $dataset --model_path $workspace -r 1 --iterations 30000 --lambda_dssim 0.2 \
            --densify_grad_threshold 0.0013 --prune_threshold 0.01 --densify_until_iter 15000 --percent_dense 0.01 \
            --position_lr_init 0.016 --position_lr_final 0.00016 --position_lr_max_steps 30000 --position_lr_start 500 \
